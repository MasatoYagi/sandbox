...
pub fn main() void {
    ...
    glorp_access3.gold = 333; // ポインタが定数でも、インスタンス側は変更可能
    ...
    print("after:{}.\n", .{glorp.experience}); // ポインタ経由でインスタンスを更新すれば、関数のスコープを抜けた後も値は更新された状態を保つ
}

// Fix 2 of 2 goes here:
fn levelUp(character_access: Character, xp: u32) void {
    // 引数が関数に渡される時は、呼び出し元の関数でどのように宣言されたかにかかわらず、関数内では常に定数として渡される
